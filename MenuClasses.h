...
public:
	...
	{
	public:
		bool Magnit, AimbotBouton, Shutter, Damage, noSound, Telekill, Kasper, NoReculBouton, WH, AutoshootButton, Knife, PVEKick, NoFlash, AutoClimbButton, SlideButton, CrouchFast, NoClaymore,
